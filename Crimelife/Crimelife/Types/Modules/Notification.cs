...
namespace Crimelife
{
    public class Notification
    {
        ...
        /*public static void SendGlobalNotification(DbPlayer dbPlayer2, string message, int durationInMS, string color, icon ico)
        {
            string text = "";
            if (ico == icon.warn)
            {
        ...
        public static void SendGlobalNotification2(Player p, string message, int durationInMS, string color, icon ico)
        {
            //DbPlayer dbPlayers = PlayerHandler.GetPlayer(player.Name);
            ...
            p.TriggerEvent("sendGlobalNotification", message, durationInMS, color, text);
        }
    }
}
