   ...
   public class DonatorShopModule : Crimelife.Module.Module<DonatorShopModule>
    {
        ...
        {
            Vector3 vector3 = new Vector3(461.81, -783.63, 27.0);
            ...
            TextLabel textLabel = NAPI.TextLabel.CreateTextLabel("~w~Donator-Shop", new Vector3(461.81, -783.63, 27.5), 10.0f, 0.5f, 0, new Color(255, 255, 255));
