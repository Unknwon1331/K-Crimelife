...
namespace Crimelife
{
    class EventModule : Crimelife.Module.Module<EventModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            {
                Name = "",
                Position = new Vector3(-428.76, 1109.66, 326.67)
            });
            ...
            foreach (EventModel eventModel in equipList)
            {
                ...
                NAPI.Marker.CreateMarker(1, new Vector3(-428.76, 1109.66, 326.67), new Vector3(), new Vector3(), 1.4f, new Color(0, 0, 0), false, 0);
