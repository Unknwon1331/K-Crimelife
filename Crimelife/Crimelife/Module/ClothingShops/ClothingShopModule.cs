                ...
                try
                {
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            val.SetData("MESSAGE", new Message("Benutze E um den Kleidungsladen zu öffnen.", Name, "#ad6f10", 3000));

                            NAPI.Marker.CreateMarker(1, Position, new Vector3(), new Vector3(), 1.0f, new Color(173, 111, 16), false, 0);
