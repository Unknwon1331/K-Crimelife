...
namespace Crimelife
{
    class FactionModule : Crimelife.Module.Module<FactionModule>
    {
        ...
        public static Vector3 StoragePosition = new Vector3(206.80786, -999.1681, -99.1);//Map load
        public static Vector3 Storage2Position = new Vector3(206.80786, -999.1681, -99.1); //Map Bug Fix
        public static int GangwarDimension = 9999;
        ...
        new NativeItem("1x MilitaryRifle - 250000$", "MilitaryRifle-250000-1"),
        ...
        new NativeItem("1x Nahkampf - 5000$", "Nahkampf-5000-1"),
        new NativeItem("1x Schweissgeraet - 15000$", "Schweissgeraet-5000-1"),


        new NativeItem("1x Fastequip - 200000$", "Fastequip-200000-1"),
        ...
        public static void initializeFraktionen()
        {
            ...
            try
            {
                NAPI.Marker.CreateMarker(1, new Vector3(205.461, -995.2021, -100.1), new Vector3(), new Vector3(), 1.0f, new Color(186, 0, 0)); //Waffenschrank
                NAPI.Marker.CreateMarker(1, new Vector3(190.64005, -994.81274, -100.09998), new Vector3(), new Vector3(), 1.0f, new Color(186, 0, 0)); //Kleiderschrank

                NAPI.Marker.CreateMarker(5, new Vector3(190.75902, -998.40625, -99.09998), new Vector3(), new Vector3(), 1.0f, new Color(186, 0, 05)); //GW Dim
                NAPI.Marker.CreateMarker(5, new Vector3(191.1686, -1002.184, -99.09998), new Vector3(), new Vector3(), 1.0f, new Color(186, 0, 0)); //Krieg Dim

                NAPI.Marker.CreateMarker(1, Storage2Position, new Vector3(), new Vector3(), 1.0f, new Color(186, 0, 0));//Enter Marker



                ColShape val3 = NAPI.ColShape.CreateCylinderColShape(new Vector3(205.461, -995.2021, -100.1), 1.4f, 1.4f, uint.MaxValue); //Waffenschrank
                val3.SetData("FUNCTION_MODEL", new FunctionModel("openFrak"));
                val3.SetData("MESSAGE", new Message("Benutze E um das Fraktionsmenü zu öffnen.", "", "#2f2f30", 3000));

                ColShape val4 = NAPI.ColShape.CreateCylinderColShape(new Vector3(190.64005, -994.81274, -100.09998), 1.4f, 1.4f, uint.MaxValue); //Kleiderschrank
                val4.SetData("FUNCTION_MODEL", new FunctionModel("openFraktionskleiderschrank"));
                val4.SetData("MESSAGE", new Message("Benutze E um den Fraktionskleiderschrank zu öffnen.", "frak", "frak", 3000));

                ColShape val2 = NAPI.ColShape.CreateCylinderColShape(new Vector3(190.75902, -998.40625, -100.09998), 1.4f, 1.4f, uint.MaxValue); //GW Dim
                val2.SetData("FUNCTION_MODEL", new FunctionModel("enterGangwarDimension"));
                val2.SetData("MESSAGE", new Message("Benutze E um die Gangwar Dimension zu betreten / verlassen.", "frak", "frak", 3000));

                ColShape val5 = NAPI.ColShape.CreateCylinderColShape(new Vector3(191.1686, -1002.184, -100.09998), 1.4f, 1.4f, uint.MaxValue); //Krieg Dim
                val5.SetData("FUNCTION_MODEL", new FunctionModel("enterKriegsDimension"));
                val5.SetData("MESSAGE", new Message("Benutze E um die Kriegs Dimension zu betreten / verlassen.", "frak", "frak", 3000));

                ColShape val = NAPI.ColShape.CreateCylinderColShape(Storage2Position, 2.4f, 2.4f, uint.MaxValue);
                val.SetData("FUNCTION_MODEL", new FunctionModel("exitFraklager"));
                val.SetData("MESSAGE", new Message("Benutze E um das Fraklager zu verlassen.", "frak", "frak", 3000));
                ...
                colShape3.SetData("MESSAGE", new Message("Benutze E um das Casino zu betreten.", "", "lightblue", 4000));
                ...
                colShape5.SetData("MESSAGE", new Message("Benutze E um den Aufsätzeshop zu öffnen.", "frak", "frak", 4000));
                ...
                foreach (Faction fraktion in factionList)
                {
                    ...
                    NAPI.Ped.CreatePed(NAPI.Util.GetHashKey("u_m_y_mani"), fraktion.Garage, 85, true, true, true, true, 0);
        ...
        public static void openFrak(Player c)
        {
            try
            {
                ...
                {
                    new NativeItem("Waffen", "workonweapon"),
                    new NativeItem("Nahkampfwaffe", "openNahkampf"),
                    new NativeItem("Items", "openitem"),
                    new NativeItem("Waffenaufsätze", "weaponcomponents"),
                    new NativeItem("Fast Equipment", "fastequip"),
        ...
        public void Fraktionswaffenschranks(Player c, string arg)
        {
            try
            {
                ...
                if (arg == "fastequip")
                {
                    ...
                    if (dbPlayer.Faction.Id == 5 || dbPlayer.Faction.Id == 6 || dbPlayer.Faction.Id == 31)
                    {
                        NativeMenu nativeMenu = new NativeMenu("Waffenschrank", dbPlayer.Faction.Name, new List<NativeItem>()
                    {
                        new NativeItem("1x FastEquipAG - 210000$", "FastEquipAG-210000-1"),
        ...
        public void enterGangwarDimension(Player c)
        {
            try
            {
                ...
                if (c.Dimension == dbPlayer.Faction.Dimension)
                {
                    ...
                    {
                        if (dbPlayer.Faction == GangwarModule.RunningGangwar.Faction)
                        {
                            ...
                            c.Position = GangwarModule.RunningGangwar.DefenderSpawn;
                        }
                        else if (dbPlayer.Faction == GangwarModule.RunningGangwar.Attacker)
                        {
                            dbPlayer.SendNotification("Du hast die Gangwar Dimension betreten.(Fraktion: " + dbPlayer.Faction.Name + ")", 3000, "orange", "[Gangwar]");
                            dbPlayer.player.RemoveAllWeapons();
                            c.Dimension = Convert.ToUInt32(GangwarDimension);
                            c.Position = GangwarModule.RunningGangwar.AttackerSpawn;
                        }
        ...
        public void exitFraklager(Player c)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        c.Dimension = 0;
                        dbPlayer.SendNotification("Fraktions Lager Verlassen");
                    }
                    else
                    {
                        dbPlayer.SendNotification("Fraktions Lager Verlassen");
                ...
                try
                {
                    ...
                    if (id == dbPlayer.Faction.Id)
                    {
                        if (c.Position.DistanceTo(dbPlayer.Faction.Storage) < 2.0f)
                        {
                            ...
                            c.Dimension = Convert.ToUInt32(dbPlayer.Faction.Dimension);
                            c.Heading = (float)91.37;

                            NAPI.Task.Run(() =>
                            {
                                c.TriggerEvent("freezePlayer", false);
                                dbPlayer.disableAllPlayerActions(false);
                                c.Position = Storage2Position;
                                c.Dimension = Convert.ToUInt32(dbPlayer.Faction.Dimension);
                                c.Heading = (float)112.68974;
                            }, 3000);
                            return;
                        }
                    }
...
new NativeItem("1x Pistol50 - 15000$", "Pistol50-15000-1")
        ...
        public void Waffenaufsaetze(Player c, string selection)
        {
            ...
            if (dbPlayer.Money >= component.Price)
            {
                ...
                WeaponManager.addWeaponComponent(dbPlayer.player, weapon, component.WeaponComponent);
            }
            else
            {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (dbPlayer.Money >= price)
                    {
                        ...
                        dbPlayer.SendNotification("Du hast " + count + "x " + item + " ausgerüstet!");
                    }
                    else
                    {
