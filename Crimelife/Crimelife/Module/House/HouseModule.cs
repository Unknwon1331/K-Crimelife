    ...
    class HouseModule : Crimelife.Module.Module<HouseModule>
    {
        ...
        public static void PressedL(DbPlayer dbPlayer)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dbPlayer.GetData<int>("IN_HOUSE") == 0) return;

                    House nearestInterior = getHouseById(dbPlayer.GetData<int>("IN_HOUSE"));
        ...
        public void leaveKeller(Player c)
        {
            try
            {
                ...
                House house = getHouseById(dbPlayer.GetData<int>("IN_HOUSE"));
                ...
                else
                {
                    foreach (HouseClothes houseClothes in house.Wardrobe)
                    {
                        ...
                        if (selection == houseClothes.name.ToLower())
                        {
                            ...
                            ClothingManager.setClothes(dbPlayer.player, houseClothes.playerClothes);
        ...
        public void SaveOutfit(Player c, string text)
        {
            try
            {
                ...
                WebhookSender.SendMessage("Wardrobe", "Spieler: " + dbPlayer.Name + " ist in seiner Wardrobe " + text + " - OUTFIT SPEICHERN", Webhooks.hauslagerlogs, "House Wardrobe");
