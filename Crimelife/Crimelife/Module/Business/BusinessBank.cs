...
namespace Crimelife
{
    internal class BusinessBank : Script
    {
        ...
        {
            if (dbPlayer.Business.Id != 0 && dbPlayer.HasData("USING_BUSINESSBANK") && !((!dbPlayer.GetData<bool>("USING_BUSINESSBANK")) ? true : false))
            {
        ...
        {
            if (dbPlayer.Business.Id != 0 && dbPlayer.Businessrank == 2 && dbPlayer.HasData("USING_BUSINESSBANK") && !((!dbPlayer.GetData<bool>("USING_BUSINESSBANK")) ? true : false))
            {
