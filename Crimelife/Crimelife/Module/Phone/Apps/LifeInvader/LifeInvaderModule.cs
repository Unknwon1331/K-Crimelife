...
namespace Crimelife
{
    class LifeInvaderModule : Crimelife.Module.Module<LifeInvaderModule>
    {
        ...
        public bool OnLoad(Player c)
        {

            ColShape p = NAPI.ColShape.CreateCylinderColShape(new Vector3(-1052, -238, 43), 1.4f, 3.4f, 0);
        ...
        public void LifeInvaderPurchaseAd(Player p, string t, DbPlayer dpPlayer)
        {
            try
            {
