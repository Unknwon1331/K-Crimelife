...
namespace Crimelife
{
    class ShopModule : Crimelife.Module.Module<ShopModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            {
                NAPI.Marker.CreateMarker(1, shop.Position, new Vector3(), new Vector3(), 1.0f, new Color(111, 171, 48), false, 0);
        ...
        public void shopBuy(Player c, string json)
        {
            try
            {
                ...
                if (dbPlayer.Money >= num)
                {
                    ...
                    WebhookSender.SendMessage("Spieler kauft was im Shop", "Der Spieler " + dbPlayer.Name + " hat folgende Items gekauft: " + NAPI.Util.ToJson(basket) + " und hat " + num + "$ bezahlt", Webhooks.shoplogs, "Shop");
