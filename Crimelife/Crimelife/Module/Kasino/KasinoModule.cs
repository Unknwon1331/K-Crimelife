    ...
    public class KasinoModule : Crimelife.Module.Module<KasinoModule>
    {
        ...
        public static void openCasinoMenu(Player c)
        {
            try
            {
                ...
                if (!dbPlayer.GetData<bool>("CASINO_ACCSE"))
                {
        ...
        {
            return KasinoDevices.FirstOrDefault(kasinoDevice => kasinoDevice.Position.DistanceTo(dbPlayer.player.Position) < kasinoDevice.Radius);
        }
        ...
        public void requestSlotInfo(Player player)
        {
            ...
            {
                TriggerEvent(player2.player, "responseSlotInfo", JsonConvert.SerializeObject(Factors));
            }
        }
