...
namespace Crimelife
{
    class FarmingModule : Crimelife.Module.Module<FarmingModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            cb.SetData("MESSAGE", new Message("Benutze E um deine Sachen zu verkaufen.", "DEALER", "green", 3000));
                    ...
                    foreach (DbPlayer dbPlayer in PlayerHandler.GetPlayers())
                    {
                        ...
                        if (client.Position.DistanceTo(farmingModel.Sammler) <= farmingModel.ColShapeRange)
                        {
                            if (dbPlayer.IsFarming)
                            {
                                ...
                                dbPlayer.SendNotification($"Du hast {farmingModel.PickupCount}x {farmingModel.Item_1} gesammelt.", 3000, "green", "FARMING");
                            }
                        }
