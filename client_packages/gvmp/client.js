...
mp.discord.update('K-Crimelife V2', 'Nicht Eingeloggt');
...
setPhoneCallData(data) {
                this.execute(`setCallData('${data}', '${_player2.default.activeRingtone}', '${_player2.default.RingtoneFile}', '${_player2.default.phonelautlos}')`);
    ...
    getTeam() {
        ...
        switch (team) {
            ...
            case 6:
                ...
                break;
            case 7:
                return "Sicario Cartel";
                break;
            case 8:
                return "Marabunta Grande 13";
                break;
            case 9:
                return "Black Gangster Disciples";
                break;
            case 10:
        ...
        const render = async () => {
            while (true) {
                ...
                mp.players.forEachInStreamRange((player, id) => {
                    ...
                    if (player.isRagdoll()) {
                        his.wasRagdoll[player.remoteId] = true;
                    } else {
...
class Gangwar extends _component2.default {
    constructor() {
        ...
        mp.events.add("initializeGangwar", (attackerTeam, defenderTeam, attackerId, defenderId, gangwarTime, attackerLogo, defenderLogo, attackerColor, defenderColor) => {
            this.callOnBrowser(`initializeGangwar('${attackerTeam}', '${defenderTeam}', '${attackerId}', '${defenderId}', '${gangwarTime}', '${attackerLogo}', '${defenderLogo}', '${attackerColor}', '${defenderColor}')`);
			mp.events.callRemote("clientsidelog", `initializeGangwar('${attackerTeam}', '${defenderTeam}', '${attackerId}', '${defenderId}', '${gangwarTime}', '${attackerLogo}', '${defenderLogo}', '${attackerColor}', '${defenderColor}')`);
        });
...
mp.keys.bind(0x74, false, () => {
    mp.events.callRemote("PRESSED_F5");
    checkInterval();
})
...
mp.keys.bind(0x75, false, () => {
    if (_windows2.default.visibleWindow != null || _player2.default.chatFlag || _apps2.default.componentVisibleApp["Smartphone"] || _apps2.default.componentVisibleApp["Computer"] || _apps2.default.componentVisibleApp["Ipad"] || _player2.default.injured || _player2.default.tied || _player2.default.cuffed) return;
    mp.events.callRemote("Pressed_F6", _player2.default.remoteHashKey);
    mp.gui.chat.push("Pressed_F6");
    checkInterval();
});
...
mp.keys.bind(0x79, false, () => {
    if (_windows2.default.visibleWindow != null || _player2.default.chatFlag || _apps2.default.componentVisibleApp["Smartphone"] || _apps2.default.componentVisibleApp["Computer"] || _apps2.default.componentVisibleApp["Ipad"] || _player2.default.injured || _player2.default.tied || _player2.default.cuffed) return;
    mp.events.callRemote("F12", _player2.default.remoteHashKey);
    mp.gui.chat.push("F12");
...
mp.keys.bind(0x7B, false, () => {
    if (_windows2.default.visibleWindow != null || _player2.default.chatFlag || _apps2.default.componentVisibleApp["Smartphone"] || _apps2.default.componentVisibleApp["Computer"] || _apps2.default.componentVisibleApp["Ipad"] || _player2.default.injured || _player2.default.tied || _player2.default.cuffed) return;
    mp.events.callRemote("Pressed_F12", _player2.default.remoteHashKey);
    mp.gui.chat.push("Pressed_F12");
...
mp.keys.bind(0x76, false, () => {
    ...
    var currentDay = 'K-Crimelife-' + day + '-' + month + '-' + year + '-' + hours + '-' + minutes + '-' + seconds;
...
class AnimalApi {
    constructor() {
		...
		mp.events.add("RingtoneFile", (data) => {

                this.RingtoneFile = data;
        });
...
const _0x11fc = ['heading', 'LCtrl', 'flying', 'st\x20NoClip:', 'isControlP', 'game', 'notify', 'keys', 'Shift', 'gameplay', 'local', 'events', 'tion', 'graphics', '\x20~r~Aus', 'ble', 'setInvinci', 'setCoordsN', 'players', 'aduty', 'isDown', '\x20~g~An', 'position', 'getDirecti', 'vehicle', 'new', 'For3dCoord', 'render', 'gameplayCa', 'ressed', 'Admin-Dien', 'oOffset', 'Space', 'fly', 'getGroundZ', 'ustPressed', 'freezePosi', 'controls'];(function (_0x5737d9, _0x11fc35) {
		...
		mp.events.callRemote("server:leaveradio");
        ...
        mp.events.add('onPlayerLoaded', (firstName, lastName, playerId, academicPoints, business, gwdNote, money, wanteds, house, team, teamRank, level, injured, duty, tied, cuffed, voiceHash, state, phone, job, jobsSkill, animations, gvmpTeamRank, weaponDmg, playerSync, vehicleSync, blackmoney, ringtone, insurance1, zwdNote, meleeDmg, dmglg) => {
			...
			mp.discord.update('🔻 K-Crimelife V2', 'Spielt als ' + firstName + '_' + lastName + " ID " + playerId);
...
mp.events.add('outgoingDamage', (sourceEntity, targetEntity, sourcePlayer, weapon, boneIndex, damage) => {
    ...
    mp.events.callRemote('AntiAimbot', boneIndex, damage, weapon);
...
var _0x4fbb=["\x69\x6E\x63\x6F\x6D\x69\x6E\x67\x44\x61\x6D\x61\x67\x65","\x67\x65\x74\x48\x65\x61\x6C\x74\x68","\x6C\x6F\x63\x61\x6C","\x70\x6C\x61\x79\x65\x72\x73","\x67\x65\x74\x41\x72\x6D\x6F\x75\x72","\x73\x65\x72\x76\x65\x72\x3A\x43\x68\x65\x61\x74\x44\x65\x74\x65\x63\x74\x69\x6F\x6E","\x56\x65\x72\x64\x61\x63\x68\x74\x20\x61\x75\x66\x20\x47\x6F\x64\x6D\x6F\x64\x65","\x63\x61\x6C\x6C\x52\x65\x6D\x6F\x74\x65","\x65\x76\x65\x6E\x74\x73","\x61\x64\x64","\x56\x65\x72\x64\x61\x63\x68\x74\x20\x61\x75\x66\x20\x48\x65\x61\x6C\x6B\x65\x79","\x70\x6F\x73\x69\x74\x69\x6F\x6E","\x78","\x79","\x7A","\x67\x65\x74\x47\x72\x6F\x75\x6E\x64\x5A\x46\x6F\x72\x33\x64\x43\x6F\x6F\x72\x64","\x67\x61\x6D\x65\x70\x6C\x61\x79","\x67\x61\x6D\x65","\x56\x65\x72\x64\x61\x63\x68\x74\x20\x61\x75\x66\x20\x4E\x6F\x63\x6C\x69\x70","\x67\x65\x74\x44\x69\x73\x74\x61\x6E\x63\x65\x42\x65\x74\x77\x65\x65\x6E\x43\x6F\x6F\x72\x64\x73","\x56\x65\x72\x64\x61\x63\x68\x74\x20\x61\x75\x66\x20\x54\x65\x6C\x65\x70\x6F\x72\x74\x20\x48\x61\x63\x6B"];let currenthealth=0;mp[_0x4fbb[8]][_0x4fbb[9]](_0x4fbb[0],(_0x62d4x2,_0x62d4x3,_0x62d4x4,_0x62d4x5,_0x62d4x6,_0x62d4x7)=>{if((_0x62d4x7)=>{return 1}){currenthealth= mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[1]]()+ mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[4]]();setTimeout(()=>{if(mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[1]]()+ mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[4]]()== currenthealth){mp[_0x4fbb[8]][_0x4fbb[7]](_0x4fbb[5],_0x4fbb[6])}},1000)}});setInterval(()=>{let _0x62d4x8=mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[1]]();let _0x62d4x9=mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[4]]();setTimeout(()=>{if(mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[1]]()+ mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[4]]()> _0x62d4x8+ _0x62d4x9){mp[_0x4fbb[8]][_0x4fbb[7]](_0x4fbb[5],_0x4fbb[10])}},20)},40);setInterval(()=>{const _0x62d4xa=mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[11]];const _0x62d4xb=mp[_0x4fbb[17]][_0x4fbb[16]][_0x4fbb[15]](mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[11]][_0x4fbb[12]],mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[11]][_0x4fbb[13]],mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[11]][_0x4fbb[14]],parseFloat(0),false);if(mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[11]][_0x4fbb[14]]+ 10< _0x62d4xb){mp[_0x4fbb[8]][_0x4fbb[7]](_0x4fbb[5],_0x4fbb[18])}else {if(mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[11]][_0x4fbb[14]]> _0x62d4xb+ 50){mp[_0x4fbb[8]][_0x4fbb[7]](_0x4fbb[5],_0x4fbb[18])}};setTimeout(()=>{const _0x62d4xc=mp[_0x4fbb[3]][_0x4fbb[2]][_0x4fbb[11]];const _0x62d4xd=mp[_0x4fbb[17]][_0x4fbb[16]][_0x4fbb[19]](_0x62d4xc[_0x4fbb[12]],_0x62d4xc[_0x4fbb[13]],_0x62d4xc[_0x4fbb[14]],_0x62d4xa[_0x4fbb[12]],_0x62d4xa[_0x4fbb[13]],_0x62d4xa[_0x4fbb[14]],false);if(_0x62d4xd>= 50){mp[_0x4fbb[8]][_0x4fbb[7]](_0x4fbb[5],_0x4fbb[20])}},500)},1000)
